...
public class CourseTest {
    ...
    public void canCreateCourse(){
        assertCreatedCourseHasCorrectParameters("Data Structures", "223", "CS", new AssignedTimeSlot(Weekday.MWF(), 1));
        assertCreatedCourseHasCorrectParameters("System Fundamentals", "231", "CS", new AssignedTimeSlot(Weekday.TR(), 7));
        assertCreatedCourseHasCorrectParameters("Discrete Mathematics", "243", "MAT", new AssignedTimeSlot(Weekday.MWF(), 3));
    }

    private static void assertCreatedCourseHasCorrectParameters(String courseName, String courseNum, String prefix, AssignedTimeSlot timeslot1) {
    ...
    public void canCombinePrefixAndCourseNumber(){
        Course course1 = new Course("CS", "223", "Data Structures", new AssignedTimeSlot(Weekday.MWF(), 1));
